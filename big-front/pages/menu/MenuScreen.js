...
import { Feather, Ionicons, Fontisto, FontAwesome, Entypo } from "@expo/vector-icons";
                ...
                <View style={{backgroundColor:'white', borderRadius:10, paddingVertical:20}}>
                    ...
                    {/* {userInfo.admin?null:
                        <TouchableOpacity style={menuStyles.menuContainer} onPress={() => {}}>
                            <View style={menuStyles.iconContainer}>
                                <Fontisto name='prescription' size={menuIconSize} color='black' />
                            </View>
                            <Text style={menuStyles.menuText}>내 처방전 보기</Text>
                        </TouchableOpacity>
                    } */}
