...
const LicenseInput = ({route, navigation}) => {
    const {admin, name, gender, user_id, pw, phone, email, birthdate, pharmacy} = route.params.userInfo;
    const [chkLicense, setChkLicense] = useState(false); // 라이센스 확인 여부, false면 다음 단계 못 넘어가게
    ...
    const signIn = async () => {
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({admin, name, gender, user_id, pw, phone, email, birthdate, pharmacy, license})// 보낼 데이터
        }
