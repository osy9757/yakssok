    ...
    return (
      <View style = {{flex : 1, alignItems : "center", backgroundColor : "#f5f7ff"}}>
        <View style = {{justifyContent : "center", alignItems : "center", width : width * 0.9, height : "45%"}}>
            {/* <Text style={{fontSize : 18, paddingTop: 10, paddingBottom :5}}>내 처방전</Text> */}
            {/* <Image source = {{uri : "https://cdn.pixabay.com/photo/2017/12/15/13/51/polynesia-3021072__480.jpg"}} style = {{width : "55%", height : "90%"}}/> */}
            ...
            <TouchableOpacity onPress = {mainOpenModal}>
                ...
                <Pressable>
                    ...
                    <Pressable onPress = {mainCloseModal} style = {{flex : 1, justifyContent : "center", alignItems : "center",  backgroundColor : "lightblue", padding:50}}>
                        {/* <Image source = {{uri : "https://cdn.pixabay.com/photo/2017/12/15/13/51/polynesia-3021072__480.jpg"}} style = {{ width : 200, height : 200}}/> */}
        ...
        <View style = {{ flex :1, width : width * 0.90}}>
          ...
          {/* flatlist */}
          <View style = {{paddingVertical : 20, paddingHorizontal : 10, backgroundColor : "white", marginBottom : 20, borderRadius : 10}}>
            <FlatList 
                data = {drugInfo}
        ...
        {/* <View style = {{flexDirection : "row", width : "100%", height : 50, paddingHorizontal : 10, justifyContent : "space-between"}} >
            <Pressable onPress = {moveToInterdictScreen} style = {{width : "100%", backgroundColor : "#5471FF", justifyContent : "center", alignItems : "center", borderRadius : 5}}>
              <Text style = {{fontSize : 18, color : "white"}}>약사와 상담하기</Text>
            </Pressable>
        </View> */}
          {/* go to main */}
          {/* <Pressable style = {{justifyContent : "center", alignItems : "center", borderBottomColor : "gray", borderBottomWidth:1, marginBottom : 5}}>
              <Text style = {{fontSize : 12}}>메인으로 돌아가기</Text>
        </Pressable> */}
