...
model = YOLO('../detect_model/best_0.994.pt')# 본인이 가지고 있는 모델 위치 (클라우드 서비스시 변경)

API_KEY = "6%2FBZRxNWs8dwSWMBNFk4YXzxB8tAKqONGDN9Qfqo9AJObQTkju5Efo%2B3P7uj08K59XXfVCGm7sn9iWWDklkHtw%3D%3D" # api key와 endpoint
